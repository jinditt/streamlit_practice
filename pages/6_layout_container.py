...
st.divider()
col1, col2, col3 = st.columns([1,2,2], gap='medium') # 1:2:2의 비율로 영역을 분할하는 것
...
st.write('컨테이너 외부')
# with form과 비슷하다고 생각하면 됨

st.subheader('2. 컨테이너 요소 추가')
